...
locals {
  ...
  template_name  = "${formatdate("YYMMDD",timestamp())}${formatdate("hhmmss",timestamp())}-Nomad-RockyLinux9"
}
...
variable "template_description" {
  type    = string
  default = "Nomad ,Consul,Docker,JDK17"
}
...
source "proxmox-iso" "autogenerated" {
  ...
  http_directory           = "ks" # same directory as inst.ks
...
build {
  ...
  provisioner "shell" {
    script = "../../../modules/provisioning_scripts/HashiCorp/Consul.sh"
    env = {
  ...
  provisioner "shell" {
    script = "../../../modules/provisioning_scripts/HashiCorp/Nomad.sh"
    env = {
